...
var page =  {
	...
	loadAddressList : function(){
		...
		_address.getAddressList(function(res){
			...
			var addressLitsHtml = _mm.renderHtml(templateAddress,res);
			$('.address-con').html(addressLitsHtml);
		},function(errMsg){
	...
	loadProductList : function(){
		...
		_order.getProductList(function(res){
			var productLitsHtml = _mm.renderHtml(templateProduct,res);
			$('.product-con').html(productLitsHtml);
		},function(errMsg){
